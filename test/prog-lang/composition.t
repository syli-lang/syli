  ...
  public fn syliTest_file.main() -> void:
    ...
    bb0:
      ...
      %Sy_accum_fn_0:fn_ptr = addr_fn(__make_closure_accum.syliTest_file.id.53_ret_i64)
      obj_set(%Sy_var0:obj_ptr, 0:i32, %Sy_accum_fn_0:fn_ptr):fn_ptr
      
      %Sy_var1:i64 = #call_direct syliTest_file.apply_twice__fn_i64_i64__i64_ret_i64 (@transfer %Sy_var0:obj_ptr, 10:i64)
      %Sy_var2:void = #call_direct syliTest_file.syli_print_i64 (%Sy_var1:i64)
      return
  end
  ...
  public fn syliTest_file.apply_twice__fn_i64_i64__i64_ret_i64(%f:obj_ptr, %x:i64) -> i64:
    ...
    bb0:
      ...
      %Sy_var0:i64 = #call_direct_fn_ptr(%Sy_accum_ptr_1:fn_ptr)  (%x:i64, @borrow %f:obj_ptr, 0:i64)
      
      %Sy_accum_ptr_2:fn_ptr = obj_get(%f:obj_ptr, 0:i32):fn_ptr
      %Sy_var1:i64 = #call_direct_fn_ptr(%Sy_accum_ptr_2:fn_ptr)  (%Sy_var0:i64, @transfer %f:obj_ptr, 0:i64)
  ...
  private fn __make_closure_accum.syliTest_file.id.53_ret_i64(%Sy_x0:i64, %Sy_clos:obj_ptr, %Sy_dp_id:i64) -> i64:
    entry: bb0
  
    bb0:
      release(%Sy_clos:obj_ptr)
      %Sy_rst:i64 = #call_direct __wrapper.syliTest_file.id.i64_ret_i64 (%Sy_x0:i64)
      return %Sy_rst:i64
  end
  
  private fn __wrapper.syliTest_file.id.i64_ret_i64(%Sy_x0:i64) -> i64:
    entry: bb0
  
    bb0:
      %Sy_s0:i64 = cast(%Sy_x0:i64 as i64)
      %Sy_rst:i64 = #call_direct syliTest_file.id__i64_ret_i64 (%Sy_s0:i64)
      return %Sy_rst:i64
  end
  ...
  bb0:
    ...
    ; nop
    %Sy_accum_fn_0 = bitcast ptr @__make_closure_accum.syliTest_file.id.53_ret_i64 to ptr
    ...
    ; nop
    %Sy_var1 = call i64 @syliTest_file.apply_twice__fn_i64_i64__i64_ret_i64(ptr addrspace(1) %Sy_var0, i64 10)
  ...
  bb0:
    ...
    %Sy_tmp_1 = call ptr addrspace(1) @syli_inlinable_ownership_borrow(ptr addrspace(1) %f)
    %Sy_var0 = call i64 %Sy_accum_ptr_1(i64 %x, ptr addrspace(1) %Sy_tmp_1, i64 0)
    ; nop
    %Sy_tmp2 = call ptr addrspace(1) @syli_inlinable_ownership_untag(ptr addrspace(1) %f)
    %Sy_tmp3 = getelementptr { i64, i64, [0 x i64] }, ptr addrspace(1) %Sy_tmp2, i32 0, i32 2, i32 0
    %Sy_accum_ptr_2 = load ptr, ptr addrspace(1) %Sy_tmp3
    %Sy_var1 = call i64 %Sy_accum_ptr_2(i64 %Sy_var0, ptr addrspace(1) %f, i64 0)
    ; nop
    ret i64 %Sy_var1
  }
  ...
  define i64 @__make_closure_accum.syliTest_file.id.53_ret_i64(i64 %Sy_x0, ptr addrspace(1) %Sy_clos, i64 %Sy_dp_id) gc "statepoint-example" {
  bb0:
  ...
  define i64 @__wrapper.syliTest_file.id.i64_ret_i64(i64 %Sy_x0) gc "statepoint-example" {
  bb0:
