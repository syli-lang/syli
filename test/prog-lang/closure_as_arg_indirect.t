  ...
  bb0:
    ...
    %Sy_tmp0 = getelementptr { i64, i64, [0 x i64] }, ptr %Sy_var0, i32 0, i32 2, i32 0
    store ptr %Sy_accum_fn_1, ptr %Sy_tmp0
    %Sy_tmp1 = getelementptr { i64, i64, [0 x i64] }, ptr %Sy_var0, i32 0, i32 2, i32 1
    store i64 1, ptr %Sy_tmp1
    ; nop
  ...
  bb1:
    ...
    br label %bb3
  bb3:
    %Sy_tmp2 = load ptr, ptr %Sy_var2
    %Sy_tmp3 = getelementptr { i64, i64, [0 x i64] }, ptr %Sy_tmp2, i32 0, i32 2, i32 0
    %Sy_accum_ptr_2 = load ptr, ptr %Sy_tmp3
    %Sy_tmp4 = load ptr, ptr %Sy_var2
    %Sy_var3 = call i64 %Sy_accum_ptr_2(i64 2, ptr %Sy_tmp4, i64 0)
    %Sy_tmp5 = load ptr, ptr %Sy_var2
    call void @syli_rt_object_decr(ptr %Sy_tmp5)
    %Sy_tmp6 = load ptr, ptr %Sy_var2
    call void @syli_rt_object_check_release(ptr %Sy_tmp6)
    ; nop
    ret i64 %Sy_var3
  }
